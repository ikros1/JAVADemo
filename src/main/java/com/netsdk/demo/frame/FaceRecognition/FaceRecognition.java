...
class FaceRecognitionFrame extends JFrame {
          ...
          public void actionPerformed(ActionEvent e) {
            if (loginPanel.checkLoginText()) {
              if (login()) {
                ...
                frame.setTitle(
                    Res.string().getFaceRecognition() + " : " + Res.string().getOnline());
              }
            }
          }
        });
  ...
  public class FaceRecognitionEventPanel extends JPanel {
    ...
    public FaceRecognitionEventPanel() {
      ...
      colorTextField.setPreferredSize(dimension2);
      ...
      colorTextField.setFont(new Font("黑体", Font.PLAIN, 11));
      ...
      faceDataPanel.add(colorLabel);
      faceDataPanel.add(colorTextField);
  ...
  private static class AnalyzerDataCB implements NetSDKLib.fAnalyzerDataCallBack {
    ...
    public void saveFaceRecognitionPic(
        Pointer pBuffer, int dwBufSize, DEV_EVENT_FACERECOGNITION_INFO faceRecognitionInfo)
  ...
  private static class FaceRecognitionRunnable implements Runnable {
    ...
    public FaceRecognitionRunnable(
  ...
  private static void showFaceRecognitionEventInfo(
      BufferedImage globalBufferedImage,
      BufferedImage personBufferedImage,
      BufferedImage candidateBufferedImage,
      DEV_EVENT_FACERECOGNITION_INFO facerecognitionInfo,
    ...
    globalPicLabel.setText(
        Res.string().getGlobalPicture()
            + " ------ ["
            + Res.string().getFaceRecognitionEvent()
            + "]");
    ...
    // 时间
    if (facerecognitionInfo.UTC == null || facerecognitionInfo.UTC.toString().equals("")) {
      timeTextField.setText("");
    } else {
    ...
    if (facerecognitionInfo.stuFaceData == null) {
      ...
      colorTextField.setText(Res.string().getColor(facerecognitionInfo.stuFaceData.emRace));
    ...
    // 候选人信息
    if (facerecognitionInfo.nRetCandidatesExNum == 0 || index == -1) {
      nameTextField.setText("");
      sexTextField2.setText("");
      birthdayTextField.setText("");
      idNoTextField.setText("");
      ...
      sexTextField2.setText(
          Res.string()
              .getSex(facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.bySex & 0xff));
      birthdayTextField.setText(
          String.valueOf((int) facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.wYear)
              + "-"
              + String.valueOf(
                  facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.byMonth & 0xff)
              + "-"
              + String.valueOf(
                  facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.byDay & 0xff));

      try {
        nameTextField.setText(
            new String(facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.szPersonName, "GBK")
                .trim());
        idNoTextField.setText(
            new String(facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.szID, "GBK").trim());
        groupIdTextField.setText(
            new String(facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.szGroupID, "GBK")
                .trim());
        groupNameTextField.setText(
            new String(facerecognitionInfo.stuCandidatesEx[index].stPersonInfo.szGroupName, "GBK")
                .trim());
      ...
      similaryTextField.setText(
          String.valueOf(facerecognitionInfo.stuCandidatesEx[index].bySimilarity & 0xff));
    }
  }
  ...
  private static void showFaceDetectEventInfo(
    ...
    globalPicLabel.setText(
        Res.string().getGlobalPicture() + " ------ [" + Res.string().getFaceDetectEvent() + "]");
    ...
    colorTextField.setText(Res.string().getColor(facedetectInfo.emRace));
